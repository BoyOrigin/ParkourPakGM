...
public class SetRemovalLobbyCommand implements CommandExecutor {

    private final ParkourPakGM plugin;

    public SetRemovalLobbyCommand(ParkourPakGM plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        this.plugin.setData("lobby.removalArea", areaBox);
        sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&aRemoval Lobby Area has been set"));
        return true;
    }
}
